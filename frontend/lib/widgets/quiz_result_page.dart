...
///
/// It displays a curated list of recommended PC builds based on the answers
/// the user provided in the interactive quiz. Each recommendation is shown
/// as a card with key specifications and a link to view more details.
...
class QuizResultsPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Read the quiz notifier to access its methods.
