          ...
          Expanded(
            child: buildsAsync.when(
              ...
              error: (error, _) => _ResultsError(
                error: error,
                onRetry: () => ref.refresh(quizRecommendedBuildsProvider(user.uid)),
              ),
            ),
          ),
        ],
    ...
    try {
      ...
      if (components.isEmpty) {
        messenger.showSnackBar(
          const SnackBar(content: Text('Unable to load components for this build.')),
        );
        return;
      }
              ...
              return SizedBox(
                ...
                child: FutureBuilder<build_model.Build>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return _BuildCard(
                      buildData: detailed,
                      onViewDetails: () => _openBuildInBuilder(context, detailed),
                      isLoading: loading,
                    );
                  },
                ),
                  ...
                  child: ClipRRect(
                    ...
                    child: Container(
                      ...
                      child: isLoading
                          ...
                          : (buildData.imageUrl != null && buildData.imageUrl!.isNotEmpty)
                              ? Image.network(
                                  buildData.imageUrl!,
                                  fit: BoxFit.cover,
                ...
                SizedBox(
                  ...
                  child: OutlinedButton(
                    ...
                    style: OutlinedButton.styleFrom(
                      ...
                      side: BorderSide(color: AppColorsDark.buttonPurple.withOpacity(0.6)),
                      padding: const EdgeInsets.symmetric(vertical: 12),
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                      backgroundColor: AppColorsDark.buttonPurple.withOpacity(0.08),
                    ),
                    child: isLoading
                        ? const SizedBox(
                            height: 18,
