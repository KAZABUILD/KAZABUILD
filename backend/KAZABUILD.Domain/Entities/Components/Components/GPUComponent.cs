...
{
    /// <summary>
    /// Represents the GPU (Graphical Processing Unit) which processes tasks requiring heavy operations such as graphics.
    /// </summary>
    public class GPUComponent : BaseComponent
    {
        /// <summary>
        /// The GPU Chipset name (e.g., NVIDIA RTX 4090, AMD Radeon RX 7900 XTX, ARC B580).
        /// </summary>
        [Required]
        ...
        /// FrameSync is used to identify the frame boundaries, permitting the data bits within the frame to be extracted
        /// </summary>
        [Required]
        ...
        public int TotalSlotAmount { get; set; } = default!;
